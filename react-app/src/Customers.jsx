...
export function SignOut(props) {
  return (
    props.user && (
      <button className='btn btn-outline-secondary' onClick={() => signOut(auth)}>
  ...
  if (signInCheckResult?.signedIn === true) {
    return (
      <>
        ...
        <p>
          Save credit card details for future use. Connect a Stripe Customer ID to a Firebase User
          ID
        </p>
        ...
        <div className='well'>
          ...
          <button className='btn btn-success' onClick={createSetupIntent} hidden={setupIntent}>
        ...
        >
          <h3>Step 2: Submit a Pyament Method</h3>
